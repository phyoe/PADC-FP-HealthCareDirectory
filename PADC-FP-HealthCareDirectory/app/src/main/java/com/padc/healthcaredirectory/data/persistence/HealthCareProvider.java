...
public class HealthCareProvider extends ContentProvider {
    ...
    private static final String sHealthcareServiceNameSelection = HealthCareServiceEntry.COLUMN_NAME + " = ?";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matchUri) {
            ...
            case HEALTHCARE_SERVICE_PHONES:
                String service_id = HealthCareContract.HealthCareServicePhoneEntry.getHealthCareServiceIdFromParam(uri);
                if (service_id != null) {
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        switch (matchUri) {
            ...
            case HEALTHCARE_SERVICE_PHONES: {
                ...
                if (_id > 0) {
                    insertedUri = HealthCareContract.HealthCareServicePhoneEntry.buildServicePhoneUri(_id);
                } else {
                    throw new SQLException("Failed to insert row into " + uri);
                }
                break;
